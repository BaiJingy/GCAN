...
class CellVGAE(GAE):
    def __init__(self, encoder, decoder_nn_dim1=64, decoder=None, gcn_or_gat='GCNGAT'):
        super(CellVGAE, self).__init__(encoder, decoder)
        assert gcn_or_gat in ['GAT', 'GATv2', 'GCN','GCNGAT'], 'Convolution must be "GCN", "GAT", or "GATv2.'
    ...
    def encode(self, *args, **kwargs):
        """"""
        if self.gcn_or_gat in ['GAT', 'GATv2','GCNGAT']:
